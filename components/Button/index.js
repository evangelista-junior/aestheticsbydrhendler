export default function Button({
  ...
  const variants = {
    ...
    dark: "bg-easyDark text-white p-4 border-1 border-easyDark rounded-sm hover:bg-gray-100 hover:text-gray-600 hover:border-gray-400 hover:rounded-md",

    darkInverse:
      "bg-transparent text-gray-600 p-4 border-1 border-gray-400 rounded-md hover:bg-easyDark hover:text-white hover:border-easyDark hover:rounded-sm",

    primaryRounded:
      "rounded-md border-1 border-primary-300 bg-primary-300 text-white hover:bg-transparent hover:text-primary-300",

    outline:
      "rounded-md border-1 border-primary-300 bg-transparent text-primary-300 hover:bg-primary-300 hover:text-white",

    outlineInverse:
      "rounded-md border-1 border-white bg-transparent text-white hover:bg-primary-300",
